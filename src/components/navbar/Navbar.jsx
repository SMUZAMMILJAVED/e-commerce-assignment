...
import image from '../../assets/images/pak.png';
  ...
  return (
    <div className="bg-white sticky top-0 z-50">
            ...
            >
              ...
              >
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  </div>:<Link to={'/login'}  className=" flex text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                      Signin
                    </Link>}

                  <div className="flow-root">
                    {user?.user?.email==='s.muzammiljaved@gmail.com'?
                     <Link
                     to={"/dashboard"}
                     className="-m-2 block p-2 font-medium text-gray-900"
                     style={{ color: mode === "dark" ? "white" : "" }}
      ...
      <header className="relative bg-white">
        ...
        >
          Discover Your Dream Wedding Suit
        </p>
